...
from Environment.environment_v6_monoChannel_p2p import Environment as env_p2p
from Environment.environment_v6_monoChannel_p2p_actors import Environment as env_p2p_actors
...
class DiffRobotEnv(gym.Env):
    ...
    def __init__(self,Nchannels=4,mode="actors",nactors=5):
        super().__init__()

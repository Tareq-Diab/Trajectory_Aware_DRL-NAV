...
class Environment ():
    ...
    def __init__(self,elemntsFile:str="/dynamicElements.Yaml",controlFrequency=20, **kwargs):
        ...
        #---------------------------------------------- p2p ----------------------------------------------------
        self.goalrandomizer=GoalRandomizer(-9,9,1)
    ...
    def reset(self):
        ...
        self.done=False
        self.colided=False
        self.goal={"x":-9,"y":0}#self.goalrandomizer.getRandomGoal() # #
    ...
    def __getObservation(self): #turn into class
        ...
        # r part of the polar coordinates
    ...
    def spawn_obj_randomly_in_raduis(self,obstacleName,centerListXY,raduis):
        ...
        self.modelStateMessage.pose.orientation.w = 0
        self.modelStatePublisher.publish(self.modelStateMessage)
        # print("DEBUG : "+ obstacleName +" should be moved by now to {} ,{}  ".format(centerListXY[0]+x_ofset,centerListXY[1]+y_ofset))

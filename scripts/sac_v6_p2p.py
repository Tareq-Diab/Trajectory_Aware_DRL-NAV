...
from Environment.diff_Robot_gym_v6_p2p import DiffRobotEnv 
import sys
...
random.seed(42)
set_random_seed(42)
env = DiffRobotEnv(nactors=12)
logDir="traing_logs"
runName="sac-p2p-{}-{}".format(args.experiment,datetime.now())
...
eval_env = DiffRobotEnv(nactors=1)

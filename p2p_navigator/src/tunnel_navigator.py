...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="tunnel Navigator")
    parser.add_argument("--model", type=str, required=True, help="Path to the model file")
    parser.add_argument("--type", type=str, default="", choices=["lidar", "M-COST", "mono"], help="Type of observation")
    args = parser.parse_args()

    # Use the parsed arguments
    nav = Navigator(args.model,args.type)
    while True:
        nav.threader()